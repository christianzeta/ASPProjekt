...
namespace ASPProjekt.Migrations
{
    ...
    [Migration("20210414201256_initial_model")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPProjekt.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPProjekt.Models.User", b =>
                {
            ...
            modelBuilder.Entity("ASPProjekt.Models.Event", b =>
                {
                    b.HasOne("ASPProjekt.Models.User", "Organizer")
            ...
            modelBuilder.Entity("EventUser", b =>
                {
                    b.HasOne("ASPProjekt.Models.User", null)
                        .WithMany()
                        .HasForeignKey("AttendeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASPProjekt.Models.Event", null)
                        .WithMany()
